...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_servies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/servies */ "./js/services/servies.js");
...
function cards() {
    ...
    Object(_services_servies__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/menu')
...
/* harmony import */ var _services_servies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/servies */ "./js/services/servies.js");
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        ...
        `;
            ...
            Object(_services_servies__WEBPACK_IMPORTED_MODULE_1__["postData"])('http://localhost:3000/requests', json)
                .then(data => {
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    const setCurrentIndex = (slideIndex, slides, current) => {
        if (slides.length < 10) {
    ...
    const setDotsOpacity = (dots, slideIndex) => {
 ...
 `;
    ...
    next.addEventListener('click', () => {
        ...
        setCurrentIndex(slideIndex, slides, current);
        setDotsOpacity(dots, slideIndex);
    });
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2021-07-11');
